...
<div class="mb-4">
    <h3 class="text-2xl font-medium text-gray-900">Daftar Kategori</h3>
    ...
    <div class="flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <form action="{{ route('admin.kategori.index') }}" method="get"
            ...
            <input type="text" name="cari" placeholder="Cari Nama Kategori ..."
                class="px-3 py-2 border border-gray-300 rounded-xl focus:outline-none focus:ring-1 focus:ring-blue-500 w-full md:w-64 shadow-sm">
            <button type="submit"
